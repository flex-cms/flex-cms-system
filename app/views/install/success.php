...
<div class="text-center space-y-8">
    <div
        class="inline-flex items-center justify-center w-20 h-20 bg-green-100 text-green-600 rounded-full shadow-inner">
    ...
    <div class="bg-white border-y border-gray-200 p-5 rounded-2xl shadow-sm text-left">
        ...
        <?php Alert::make('Запазете тези данни на сигурно място!')->warning() ?>
    </div>

    <?= Link::make('/admin/dashboard', 'Преминаване към таблото') ?>
</div>
