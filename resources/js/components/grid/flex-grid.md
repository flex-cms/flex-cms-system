...
<flex-grid cols="1" md-cols="2" gap="5">
    <flex-input name="name" label="Име"></flex-input>
    <flex-input name="slug" label="Slug"></flex-input>
</flex-grid>
```
...
```html
<flex-grid cols="3" gap="4"></flex-grid>
```
...
```html
<flex-grid cols="2" gap-x="24px" gap-y="1.5rem"></flex-grid>
```
...
```html
<flex-form action="/admin/pages/store" method="POST" ajax>
    <flex-grid cols="1" md-cols="2" gap="5">
        <flex-input name="name" label="Име" required></flex-input>
        <flex-input name="slug" label="Slug" required></flex-input>
        <flex-input type="number" name="position" label="Позиция"></flex-input>
    </flex-grid>
